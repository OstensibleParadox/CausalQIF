...
/-! # Finite Discrete Probability — Core

The `FinitePMF` structure plus its two structural transports: `comapEquiv`
(pull along an equivalence of carrier types) and `map` (pushforward along an
arbitrary function).
-/
